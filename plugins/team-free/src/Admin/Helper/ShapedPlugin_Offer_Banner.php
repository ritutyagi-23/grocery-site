	...
	public function get_active_offers() {
		...
		$offers = array(
			'black_friday' => array(
				...
				'image' => SPT_PLUGIN_ROOT . 'src/Admin/img/offer-banner/bfcm-offer-banner.svg',
				'link'  => 'https://getwpteam.com/pricing/?campaign=steam&ref=423',
			),
			'new_year'     => array(
				'id'    => 'new_year_2026',
				'start' => strtotime( '2025-12-26 00:00:00' ),
				'end'   => strtotime( '2026-01-14 23:59:59' ),
				'image' => SPT_PLUGIN_ROOT . 'src/Admin/img/offer-banner/new-year-offer-banner.svg',
				'link'  => 'https://getwpteam.com/pricing/?campaign=steam&ref=423',
			),
		);
