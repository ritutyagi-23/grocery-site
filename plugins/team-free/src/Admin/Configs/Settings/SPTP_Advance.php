			...
			array(
				...
				'fields' => array(
					array(
						...
						'title_info' => __( 'Check this box if you would like SmartTeam to completely clean-up all of its data when the plugin is deleted.', 'team-free' ),
						'default'    => false,
					),
					array(
						'id'         => 'sptf_use_cache',
						...
						'title_info' => __( 'Enable/Disable plugin cache. To make SmartTeam faster, keep enable cache. The cache is enabled by default.', 'team-free' ),
						'default'    => true,
