			...
			array(
				...
				'fields' => array(
					array(
						'type'    => 'notice',
						'style'   => 'normal',
						'content' => __( 'Want to customize everything (typography, color, and margin) easily', 'team-free' ) . '? <a href="https://getwpteam.com/pricing/?ref=1" target="_blank"><b>' . __( 'Upgrade to Pro!', 'team-free' ) . '</b></a>
						' . __( 'P.S. Note: The color and margin options work in the lite version.', 'team-free' ),
					),
					array(
