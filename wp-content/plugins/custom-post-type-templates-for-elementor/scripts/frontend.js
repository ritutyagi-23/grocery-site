(function() {
	...
	function createItem(item) {
		...
		if (obj.querySelector(".miga_custom_posts_post_title")) obj.querySelector(".miga_custom_posts_post_title").innerHTML = item.title;
		if (obj.querySelector(".miga_custom_posts_post_date")) obj.querySelector(".miga_custom_posts_post_date").innerHTML = item.date;
		if (obj.querySelector(".miga_custom_posts_post_thumb")) obj.querySelector(".miga_custom_posts_post_thumb").innerHTML = item.thumbnail;
		if (obj.querySelector(".miga_custom_posts_post_tags")) obj.querySelector(".miga_custom_posts_post_tags").innerHTML = tags;
		if (obj.querySelector(".miga_custom_posts_post_excerpt")) obj.querySelector(".miga_custom_posts_post_excerpt").innerHTML = item.excerpt;
		return obj;
	}
})();
